...
export async function updateUserProfile(
  ...
  return request<API.BaseResponseUserVO>('/user/update/profile', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 此处后端没有提供注释 POST /user/vip/redeem */
export async function redeemVipCode(
  body: API.UserRedeemVipRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseUserVO>('/user/vip/redeem', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
